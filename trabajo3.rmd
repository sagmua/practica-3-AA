...
Una vez que hemos definido la funcion, realizamos una evaluación del error 100 veces, de forma que cálculemos como resultado final la media de los errores generados para cada una de las 100 particiones:
